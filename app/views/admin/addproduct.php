        ...
        <form action="" id="form_upload" method="POST" enctype="multipart/form-data">
            ...
            <div class="col">
                ...
                <!-- <div class="col1">
                    <div class="tensp">
                        <div class="text_name">
                            <label for="fileUpload_3">Ảnh chi tiết 3 <span>*</span></label>
                        </div>
                        <div class="inp">
                            <input type="file" id="fileUpload_3"  accept=".png, .jpg, .jpeg, .gif" name="fileUpload_3" >
                        </div>
                ...
                <div class="col1">
                    <div class="tensp">
                        <div class="text_name">
                            <label for="fileUpload_4">Ảnh chi tiết 4 <span>*</span></label>
                        </div>
                        <div class="inp">
                            <input type="file" id="fileUpload_4" accept=".png, .jpg, .jpeg, .gif" name="fileUpload_4" >
                        </div>
                ...
                <div class="col1">
                    <div class="tensp">
                        <div class="text_name">
                            <label for="fileUpload_5">Ảnh chi tiết 5 <span>*</span></label>
                        </div>
                        <div class="inp">
                            <input type="file" id="fileUpload_5" accept=".png, .jpg, .jpeg, .gif" name="fileUpload_5" >
                            <input type="hidden" id="id_img" value="6" >
                        </div>
