        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="/wp-admin/ql-category">Quản lý danh mục</a></li>
                    <li><a href="/wp-admin/ql-user">Quản lý user </a></li>
                    <li><a href="/wp-admin/ql-code-sale">Quản lý mã giảm giá</a></li>
                    <li><a href="/wp-admin/ql-historyrecharge">Quản lý nạp thẻ </a></li>
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                            <li><a href="/outlogin" data-toggle="tooltip" data-placement="bottom" title="ĐĂNG XUẤT"><b>Đăng xuất <i class="fas fa-sign-out-alt"></i></b></a></li>
                        </ul>
                    </li>
