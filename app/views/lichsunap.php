        ...
        <div class="col-md-12">
          ...
          <h2 class="c-font-bold c-font-28">ID Web: 532652</h2> 
                    <h2 class="c-font-bold c-font-28">
                        ...
                        // echo '  ' . $_SESSION["username_show"] . ' ';
                      
                    </h2>
                    <h2 class="c-font-22">Thành viên</h2>
          
                    // echo '   <h2 class="c-font-22">' . $email . '</h2> <h2 class="c-font-22 c-font-red">';echo '' . number_format($tien, 0, ',', '.') . ' </b>'; ?></h2>
                </center>
            </div>
        </div>
    </div> -->
                    ...
                    <table class="table table-bordered table-striped table-module">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th width="auto"><b>Seri:</b></th>
                                <th width="auto"><b>Mã thẻ:</b></th>
                                <th width="auto"><b>Mệnh giá</b></th>
