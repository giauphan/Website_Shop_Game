...
<div class="c-layout-page">
   ...
   <div class="c-content-title-1">
      <h3 class="c-center c-font-uppercase c-font-bold">DỊCH VỤ MUA THẺ </h3>
   ...
   <!-- BEGIN: PAGE CONTENT -->
   <div class="c-content-box c-size-lg c-overflow-hide c-bg-white font-roboto" style=" padding:  0 0 80px!important ;">
      <div class="container">
      </div>
            ...
            <div class="row" style="margin-top: 50px;">
               <div class="col-md-8" style="float:none;margin:0 auto;">
                  <form method="POST" action="">
                     ...
                     ?>
                        <div class="form-group">
                           <button type="submit" class="btn btn-success btn-block" name="submit_nap">MUA NGAY</button>
                        </div>
                     <?php
                     } else {
                     ?>
                        <div class="form-group">
                           <a href="?act=dangnhap" class="btn btn-success btn-block">ĐĂNG NHẬP</a>
                        </div>
                     <?php
                     }
                     ?>
